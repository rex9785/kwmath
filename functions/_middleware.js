...
export async function onRequest(context) {
  ...
  //   대상은 _consult.js 의 SLUGS 에 등록된 주소뿐. **그 외 요청은 여기서 아무 일도 일어나지 않는다**
  //   (2026-09-07 정정: 원래 「네 개뿐」이라고 적혀 있었는데 같은 날 세 명을 빼서 한 개가 됐었다.
  //    개수를 적으면 또 어긋나므로 개수를 안 적는다. 현재 목록은 _consult.js 38행 근처에서 볼 것.)
